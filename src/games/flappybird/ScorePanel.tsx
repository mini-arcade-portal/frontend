...
export function ScorePanel({ score, pipesPassed, difficulty }: ScorePanelProps) {
    ...
    <aside className="flex flex-col gap-5">
      ...
      <div className="card-dark p-5">
        ...
        <div className="space-y-2.5 text-sm">
          <StatRow label="Átrepült csövek" value={`${pipesPassed}`} />
          <StatRow label="Pontszám" value={`${score}`} highlight={score > 0} />
        </div>
      </div>
